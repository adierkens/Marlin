...
#define CUSTOM_MACHINE_NAME "Adam's Printer"
...
#define Z_MIN_PROBE_REPEATABILITY_TEST  // If not commented out, Z-Probe Repeatability test will be included if Auto Bed Leveling is Enabled.
  ...
  #define Z_PROBE_OFFSET_FROM_EXTRUDER -1.4      // Z probe to nozzle Z offset: -below (always!)
                                               // The higher the # the closer it'll be to the bed.
  ...
  #define Z_PROBE_END_SCRIPT "M280 P0 S90" // These commands will be executed in the end of G29 routine.
...
#define HOMING_FEEDRATE {3500, 3500, 500, 0}  // set the homing speeds (mm/min)

// default settings

#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,387,671}  // default steps per unit for Ultimaker
